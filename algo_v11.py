...
def main(electrogram_path, perfusion_path, perfusion_path2, bp_path, period, num_lasers, extra, treat, flname, patient,
         bp1, hrs):
...
#     output = main(perfusion_path=lsr1, perfusion_path2=lsr2, bp_path=bp, electrogram_path=ecg, period=1, extra=0,
#                   num_lasers=2, treat="IDK", flname="d", patient="a", bp1="1", hrs="q")
