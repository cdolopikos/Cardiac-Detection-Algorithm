...
#endif // QT_CONFIG(tooltip)
        self.maxTracesCheck.setText(QCoreApplication.translate("Form", u"Max Traces_unzipped_examples:", None))
...
#if QT_CONFIG(tooltip)
        self.maxTracesSpin.setToolTip(QCoreApplication.translate("Form", u"If multiple curves are displayed in this plot, check \"Max Traces_unzipped_examples\" and set this value to limit the number of traces that are displayed.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
