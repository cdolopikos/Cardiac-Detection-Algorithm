...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.maxTracesCheck.setText(QtWidgets.QApplication.translate("Form", "Max Traces_unzipped_examples:", None, -1))
        ...
        self.maxTracesSpin.setToolTip(QtWidgets.QApplication.translate("Form", "If multiple curves are displayed in this plot, check \"Max Traces_unzipped_examples\" and set this value to limit the number of traces that are displayed.", None, -1))
