...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.maxTracesCheck.setText(_translate("Form", "Max Traces_unzipped_examples:"))
        ...
        self.maxTracesSpin.setToolTip(_translate("Form", "If multiple curves are displayed in this plot, check \"Max Traces_unzipped_examples\" and set this value to limit the number of traces that are displayed."))
