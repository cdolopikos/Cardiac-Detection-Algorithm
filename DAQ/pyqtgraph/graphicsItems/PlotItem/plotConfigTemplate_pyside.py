...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.maxTracesCheck.setText(QtGui.QApplication.translate("Form", "Max Traces_unzipped_examples:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.maxTracesSpin.setToolTip(QtGui.QApplication.translate("Form", "If multiple curves are displayed in this plot, check \"Max Traces_unzipped_examples\" and set this value to limit the number of traces that are displayed.", None, QtGui.QApplication.UnicodeUTF8))
